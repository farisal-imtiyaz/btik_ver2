...
public class ActivityAddressBindingImpl extends ActivityAddressBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.teks_atas, 1);
        sViewsWithIds.put(R.id.back, 2);
        sViewsWithIds.put(R.id.street, 3);
        sViewsWithIds.put(R.id.city, 4);
        sViewsWithIds.put(R.id.no_hp, 5);
        sViewsWithIds.put(R.id.postal_code, 6);
        sViewsWithIds.put(R.id.btn_save_address, 7);
    }
    // views
    @NonNull
